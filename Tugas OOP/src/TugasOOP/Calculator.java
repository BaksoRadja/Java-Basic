...
public class Calculator {
    ...
    void cek_prima() {
        ...
        // Memastikan Apakah a Adalah Bilangan Prima Dengan Mencari Faktor dari Bilangan
        // a
        int faktor = 0;
        for (int i = 1; i <= a; i++) {
            if ((a % i) == 0) {
        ...
        // Jika Jumlah Faktor Bilangan a adalah 2 maka Bilangan a MERUPAKAN Bilangan
        // Prima Selain itu, maka Bilangan a BUKAN Bilangan Prima
        if (faktor == 2) {
    ...
    void daftar_prima() {
        ...
        for (int i = 2; i <= a; i++) {
            ...
            int faktor = 0;
            // Memastikan apakah bilangan i adalah prima dengan mencari faktor menggunakan
            // modulus
            for (int j = 1; j <= i; j++) {
            ...
            // jika jumlah faktor dari bilangan i = 2 maka bilangan i adalah bilangan prima
            // dan akan di print
            if (faktor == 2) {
                System.out.print(i + ", ");
            }
    ...
    void waktu_temu() {
        ...
        while (true) {
            ...
            if (jarak < 0 || kec_a < 0 || kec_b < 0) {
                System.out.println(
                        "Salah Satu atau lebih dari Input Adalah Bilangan Negatif, Masukkan Bilangan Positif !!");
                continue;
            }

            // Menghitung Waktu Bertemunya kedua kekasih menggunakan rumus
            // wp = waktu bertemunya kedua kekasih (Hasil akhirnya dalam bentuk menit),
            // kec_a = kecepatan si a, kec_b = Kecepatan si b, jarak = jarak antara si a dan
            // b
            float wp = (jarak / (kec_a + kec_b)) * 60;

            // Mensimulasikan pergerakan sepasang kekasih per menitnya menggunakan looping
            // for
